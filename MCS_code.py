...
def cargar_archivo(archivo):
    try:
        ...
        if not df_final.empty:
            ...
            st.write(f" - Pressure: {df_final['Pres'].min():.2e} a {df_final['Pres'].max():.2e} Pa")
            st.write(f" - Temperature: {df_final['T'].min():.1f} a {df_final['T'].max():.1f} K")
            st.write(f" - Altitude: {df_final['Alt'].min():.1f} a {df_final['Alt'].max():.1f} km")
            st.write(f" - Latitude: {df_final['Lat'].min():.1f} a {df_final['Lat'].max():.1f}°")
            st.write(f" - Longitude: {df_final['Lon'].min():.1f} a {df_final['Lon'].max():.1f}°")
